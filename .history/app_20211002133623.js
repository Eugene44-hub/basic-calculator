...
class Calculator {
    ...
    changeBackground(bodyColor, delButtonColor, resetButtonColor, equalsButtonColor, buttonContainerColor, screenColor, toggleBarColor) {
        ...
        toggleBar.style.backgroundColor = buttonContainerColor
...
- White (text): hsl(0, 0, 100%)*/
    ...
    toggle(number) {
        ...
        if (number == 2) {
            ...
            this.changeBackground('hsl(0, 0%,90%)', 'hsl(185, 42%, 37%)', 'hsl(185, 42%, 37%)', 'hsl(25, 98%, 40%)', 'hsl(0, 5%, 81%)', 'white')
        }
        if (number == 3) {
