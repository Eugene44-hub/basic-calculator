...
class Calculator {
    ...
    appendNumber(input) {
        ...
        // let currentOperand = inputs.textContent + input;
        // this.updateDisplay(currentOperand)
        console.log(this.input)
    }

    updateDisplay(numbers) {
        let inputs = document.querySelector('.result');
        inputs.textContent = numbers;
    }
...
function eventListeners() {
    ...
    //     const calculator = new Calculator(buttonVal.value)
    ...
    buttonVal.addEventListener('click', e => {
        const calculator = new Calculator(buttonVal.textContent)
        calculator.appendNumber(buttonVal.textContent);
