...
class Calculator {
    ...
    toggle(number) {
        ...
        if (number.id == 'one') {
            ...
            this.changeBackground('hsl(222, 26%, 31%)', 'hsl(225, 21%, 49%)', 'hsl(225, 21%, 49%)', 'hsl(6, 63%, 50%)', 'hsl(223, 31%, 20%)', 'hsl(224, 36%, 15%)', 'hsl(223, 31%, 20%)', 'hsl(6, 63%, 50%)', 'white', '0 4px hsl(224, 28%, 35%)', '')
        }
        if (number.id == 'two') {
