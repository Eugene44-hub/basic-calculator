...
class Calculator {
    ...
    changeBackground(bodyColor, delButtonColor, resetButtonColor, equalsButtonColor, buttonContainerColor, screenColor, toggleBarColor, toggleColor, textColor, resetShadow, delShadow, equalShadow) {
        ...
        resetButton.style.boxShadow = reset
        deleteButton.style.boxShadow = del equalsButton.style.boxShadow = delS
          /*Very dark violet (main background): hsl(268, 75%- Very dark violet (toggle background, keypad background, screen background): hsl(268, 71%, 12%)
